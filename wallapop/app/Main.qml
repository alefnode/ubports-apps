...
MainView {
  ...
  applicationName: "alefnode.wallapop"
  ...
  WebEngineView {
    ...
    profile:  WebEngineProfile {
      ...
      storageName: "Storage"
      persistentStoragePath: "/home/phablet/.cache/alefnode.wallapop/alefnode.wallapop/QtWebEngine"
    }
    anchors {
      fill:parent
      centerIn: parent.verticalCenter
    }
    url: "https://web.wallapop.com"
    userScripts: [
      WebEngineScript {
  ...
  RadialBottomEdge {
    ...
    actions: [
      ...
      RadialAction {
        ...
        iconName: "home"
        onTriggered: {
          webview.url = 'https://web.wallapop.com/chat'
        }
        text: qsTr("Home")
      },
      RadialAction {
